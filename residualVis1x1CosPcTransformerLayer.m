classdef residualVis1x1CosPcTransformerLayer < nnet.layer.Layer % & nnet.layer.Formattable (Optional)
    ...
    methods
        function layer = residualVis1x1CosPcTransformerLayer(numInChannels, numResChannels, name)
        ...
        function [Z] = predict(layer, X)
            ...
            K = layer.Wk * X1 + layer.Wk0;
            Q = layer.Wq * X1 + layer.Wq0;
