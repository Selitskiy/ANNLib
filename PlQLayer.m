classdef PlQLayer < nnet.layer.Layer %& nnet.layer.Formattable & nnet.layer.Acceleratable %(Optional)
    ...
    methods
        function layer = PlQLayer(name, numInChannels)
        ...
        function Z = predict(layer, X)
            ...
            Z = layer.A4 .* (X - layer.W4) .^ 4 + layer.A3 .* (X - layer.W3) .^ 3 + layer.A2 .* (X - layer.W2) .^ 2 + layer.A .* (X - layer.W) + layer.W0;
