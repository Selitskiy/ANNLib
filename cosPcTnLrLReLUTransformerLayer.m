classdef cosPcTnLrLReLUTransformerLayer < nnet.layer.Layer % & nnet.layer.Formattable (Optional)
    ...
    methods
        function layer = cosPcTnLrLReLUTransformerLayer(numInChannels, slopeAq, slopeAk, slopeBq, slopeBk, name)
