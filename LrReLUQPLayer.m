classdef LrReLUQPLayer < nnet.layer.Layer %& nnet.layer.Acceleratable %& nnet.layer.Formattable & nnet.layer.Acceleratable %(Optional)
    ...
    methods
        function layer = LrReLUQPLayer(name, numInChannels, numOutChannels, numOutProduct, slope)
            ...
            layer.Description = "LReLU small fi qp KAN layer";
            ...
            %layer.W = bound * (2. * rand([lyaer.numOutChannels, layer.numInChannels],'single') - 1.);

            % Initialize scaling coefficient.
            if slope == 0
                layer.A = bound * rand([numOutChannels*numOutProduct numInChannels]);
            else
                layer.A = ones([numOutChannels*numOutProduct numInChannels]) * slope;
