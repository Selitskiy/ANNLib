classdef Pl2QLayer < nnet.layer.Layer %& nnet.layer.Formattable & nnet.layer.Acceleratable %(Optional)
    ...
    methods
        function layer = Pl2QLayer(name, numInChannels)
        ...
        function Z = predict(layer, X)
            ...
            Z = layer.A2 .* (X - layer.W2) .^ 2 + layer.A .* (X - layer.W) + layer.W0;
