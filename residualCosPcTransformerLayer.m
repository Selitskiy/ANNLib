classdef residualCosPcTransformerLayer < nnet.layer.Layer % & nnet.layer.Formattable (Optional)
    ...
    methods
        function layer = residualCosPcTransformerLayer(numInChannels, numResChannels, name)
