classdef resTBTransAENet2D < resTBTransAELayers2D & AEBaseNet2D & AEInputNet2D

    properties
    end

    methods
        function net = resTBTransAENet2D(x_off, x_in, t_in, y_off, y_out, t_out, t_out_ae, ini_rate, max_epoch, k_inject, bottle_coeff)
