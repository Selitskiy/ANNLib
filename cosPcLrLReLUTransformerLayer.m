classdef cosPcLrLReLUTransformerLayer < nnet.layer.Layer % & nnet.layer.Formattable (Optional)
    ...
    methods
        function layer = cosPcLrLReLUTransformerLayer(numInChannels, slopeAq, slopeAk, slopeBq, slopeBk, name)
