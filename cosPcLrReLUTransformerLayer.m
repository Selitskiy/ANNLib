classdef cosPcLrReLUTransformerLayer < nnet.layer.Layer % & nnet.layer.Formattable (Optional)
    ...
    methods
        function layer = cosPcLrReLUTransformerLayer(numInChannels, slopeQ, slopeK, name)
