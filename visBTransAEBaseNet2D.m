classdef visBTransAEBaseNet2D < visBTransAEBaseLayers2D & BaseNet2D & MLPInputNet2D
    ...
    methods
        function net = visBTransAEBaseNet2D(x_off, x_in, t_in, y_off, y_out, t_out, ini_rate, max_epoch, bottle_coeff)
