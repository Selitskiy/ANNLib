classdef residualFCLayer < nnet.layer.Layer % & nnet.layer.Formattable (Optional)
    ...
    methods
        function layer = residualFCLayer(numInChannels, numOutChannels, numResChannels, name)
            ...
            layer.Description = "Residual fullyConnected " + numInChannels + " channels";
        ...
        function [Z] = predict(layer, X)
            ...
            Z = vertcat(Y, X(layer.numInChannels-layer.numResChannels+1:layer.numInChannels,:));
