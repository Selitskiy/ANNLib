classdef CReLULayer < nnet.layer.Layer % & nnet.layer.Formattable (Optional)
    ...
    methods
        function layer = CReLULayer(name) %, numInChannels, numOutChannels)
