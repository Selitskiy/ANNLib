classdef vis4x4x3BatchTransformerLayer < nnet.layer.Layer % & nnet.layer.Formattable (Optional)
    ...
    methods
        function layer = vis4x4x3BatchTransformerLayer(numInChannels, numPatchV, numPatchH, name)
