classdef residualVis5x5CosPcTransformerLayer < nnet.layer.Layer % & nnet.layer.Formattable (Optional)
    ...
    methods
        function layer = residualVis5x5CosPcTransformerLayer(numInChannels, numPatchV, numPatchH, numResChannels, name)
            ...
            layer.Description = "Residual Visual 5x5x1 Primary Components Transformer" + numPatchV*numPatchH + " channels";
