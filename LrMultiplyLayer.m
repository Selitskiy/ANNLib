classdef LrMultiplyLayer < nnet.layer.Layer % & nnet.layer.Formattable (Optional)
    ...
    methods
        function layer = LrMultiplyLayer(name, numInChannels, numMultiply) %, numOutChannels)
            ...
            layer.Description = "Learning Multiply layer";

            layer.numInChannels = numInChannels;
            layer.numMultiply = numMultiply;
            layer.numOutChannels = numInChannels * numMultiply;


            % Initialize weight coefficients.
            W1 = eye(layer.numInChannels);
            layer.W = W1;
            for i = 1:numMultiply-1
                layer.W = vertcat(layer.W, W1);
            end
