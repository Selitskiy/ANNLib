classdef cosPeLrReLUTransformerLayer < nnet.layer.Layer % & nnet.layer.Formattable (Optional)
    ...
    methods
        function layer = cosPeLrReLUTransformerLayer(numInChannels, slopeQ, slopeK, name)
            ...
            if slopeQ == 0
                ...
                layer.Aq = ones([numInChannels 1]) * slopeQ;
            end
            ...
            if slopeK == 0
                ...
                layer.Ak = ones([numInChannels 1]) * slopeK;
            end
        end
        ...
        function [Z] = predict(layer, X)
            ...
            layer.Ak(layer.Ak > layer.slopeK) = layer.slopeK;
            layer.Ak(layer.Ak < 0) = 0;
            PMk = Kx>=0;
            K = layer.Ak .* Kx .* PMk;

            Qx = layer.Wq * X + layer.Wq0;
            layer.Aq(layer.Aq > layer.slopeQ) = layer.slopeQ;
