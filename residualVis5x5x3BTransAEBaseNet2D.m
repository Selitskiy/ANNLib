classdef residualVis5x5x3BTransAEBaseNet2D < residualVis5x5x3BTransAEBaseLayers2D & BaseNet2D & MLPInputNet2D
    ...
    methods
        function net = residualVis5x5x3BTransAEBaseNet2D(x_off, x_in, t_in, y_off, y_out, t_out, ini_rate, max_epoch,...
            ...
            net = net@residualVis5x5x3BTransAEBaseLayers2D();
            ...
            net.name = "residualVis5x5x3BTransAeBase2d";
