classdef ExpQLayer < nnet.layer.Layer %& nnet.layer.Formattable & nnet.layer.Acceleratable %(Optional)
    ...
    methods
        function layer = ExpQLayer(name, numInChannels)
            ...
            layer.W = rand([numInChannels, 1],'single');
            layer.W0 = rand([numInChannels, 1],'single');
        ...
        function Z = predict(layer, X)
            ...
            Z = layer.A .* exp(layer.W .* (X - layer.W0));
