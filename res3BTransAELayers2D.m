classdef res3BTransAELayers2D
    properties
    end

    methods

        function net = res3BTransAELayers2D()
        end
        ...
        function net = Create(net)
            ...
            layers = [
                ...
                residualDpBatchTransformerLayer(net.k_bottle+2*net.k_inject, net.k_inject, "b_k_hid2")


                residualFCLayer(net.k_bottle+3*net.k_inject, net.k_hid2+net.k_inject, net.k_inject,'FeatureExt2') 
                
                %LrReLULayer('LrReLU2', net.k_hid2+2*net.k_inject, 1)
                residualDpBatchTransformerLayer(net.k_hid2+2*net.k_inject, net.k_inject, "b_k_hid3")
